...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildMyBookingsCard() {
    return GestureDetector(
      onTap: () {
        CcRouteHelper.push(CcRouteConstants.myBookings);
      },
      child: Container(
        width: double.infinity,
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.chevron_right, color: Color(0xFF7A96A4), size: 20),
          ],
        ),
      ),
    );
  ...
  Widget _buildInsuranceCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF055F58).withValues(alpha: 0.25),
            blurRadius: 8,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (hasInsurance)
                        ...
                        Text(
                          'Get covered with trusted partners',
                          style: GoogleFonts.dmSans(
                            fontSize: 12,
                            fontWeight: FontWeight.w400,
                            color: Colors.white.withValues(alpha: 0.7),
          ...
          Container(
            ...
            child: Row(
              children: [
                if (hasInsurance)
                  Expanded(
                    child: GestureDetector(
                      onTap: () {
                        CcRouteHelper.push(CcRouteConstants.insuranceClaims);
                      },
                      child: Container(
                ...
                if (hasInsurance) const SizedBox(width: 10),
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      CcRouteHelper.push(CcRouteConstants.insurance);
                    },
                    child: Container(
                      padding: const EdgeInsets.symmetric(vertical: 12),
                      decoration: BoxDecoration(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(
                            hasInsurance ? 'Add New' : 'Get Insurance',
                            style: GoogleFonts.sora(
                              fontSize: 13,
                              fontWeight: FontWeight.w700,
                              color: hasInsurance
